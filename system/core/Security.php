...
class CI_Security {
	...
	public function xss_clean($str, $is_image = FALSE)
	{
		 ...
		 */
		$words = array(
			'CI', 'expression', 'vbscript', 'jscript', 'wscript',
	...
	{
		// All CI event handlers (e.g. onload, onclick, onmouseover), style, and xmlns
	...
	protected function _js_link_removal($match)
	{
		return str_replace(
			$match[1],
			preg_replace(
				'#href=.*?(?:(?:alert|prompt|confirm)(?:\(|&\#40;)|CI:|livescript:|mocha:|charset=|window\.|document\.|\.cookie|<script|<xss|data\s*:)#si',
				'',
	...
	protected function _js_img_removal($match)
	{
		return str_replace(
			$match[1],
			preg_replace(
				'#src=.*?(?:(?:alert|prompt|confirm)(?:\(|&\#40;)|CI:|livescript:|mocha:|charset=|window\.|document\.|\.cookie|<script|<xss|base64\s*,)#si',
				'',
				$this->_filter_attributes(str_replace(array('<', '>'), '', $match[1]))
			),
			$match[0]
