 ...
 * @category	Javascript
 * @author		EllisLab Dev Team
 * @link		http://codeigniter.com/user_guide/libraries/CI.html
 */
class CI_Javascript {
	...
	public function __construct($params = array())
	{
		...
		$this->CI->load->library('CI/'.$js_library_driver, array('autoload' => $autoload));
	 ...
	 * Blur
	 *
	 * Outputs a CI library blur event
	 *
	 * @access	public
	 ...
	 * Change
	 *
	 * Outputs a CI library change event
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @param	string	The code to execute
	 ...
	 * Click
	 *
	 * Outputs a CI library click event
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @param	string	The code to execute
	 ...
	 * Double Click
	 *
	 * Outputs a CI library dblclick event
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @param	string	The code to execute
	 ...
	 * Error
	 *
	 * Outputs a CI library error event
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @param	string	The code to execute
	 ...
	 * Focus
	 *
	 * Outputs a CI library focus event
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @param	string	The code to execute
	 ...
	 * Hover
	 *
	 * Outputs a CI library hover event
	 *
	 * @access	public
	 ...
	 * Keydown
	 *
	 * Outputs a CI library keydown event
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @param	string	The code to execute
	 ...
	 * Load
	 *
	 * Outputs a CI library load event
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @param	string	The code to execute
	 ...
	 * Mousedown
	 *
	 * Outputs a CI library mousedown event
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @param	string	The code to execute
	 ...
	 * Mouse Out
	 *
	 * Outputs a CI library mouseout event
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @param	string	The code to execute
	 ...
	 * Mouse Over
	 *
	 * Outputs a CI library mouseover event
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @param	string	The code to execute
	 ...
	 * Mouseup
	 *
	 * Outputs a CI library mouseup event
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @param	string	The code to execute
	 ...
	 * Output
	 *
	 * Outputs the called CI to the screen
	 *
	 * @access	public
	 ...
	 * Resize
	 *
	 * Outputs a CI library resize event
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @param	string	The code to execute
	 ...
	 * Scroll
	 *
	 * Outputs a CI library scroll event
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @param	string	The code to execute
	 ...
	 * Unload
	 *
	 * Outputs a CI library unload event
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @param	string	The code to execute
	 ...
	 * Add Class
	 *
	 * Outputs a CI library addClass event
	 *
	 * @access	public
	 * @param	string	- element
	 ...
	 * Animate
	 *
	 * Outputs a CI library animate event
	 *
	 * @access	public
	 * @param	string	- element
	 ...
	 * Fade In
	 *
	 * Outputs a CI library hide event
	 *
	 * @access	public
	 * @param	string	- element
	 * @param	string	- One of 'slow', 'normal', 'fast', or time in milliseconds
	 ...
	 * Slide Up
	 *
	 * Outputs a CI library slideUp event
	 *
	 * @access	public
	 * @param	string	- element
	 * @param	string	- One of 'slow', 'normal', 'fast', or time in milliseconds
	 ...
	 * Remove Class
	 *
	 * Outputs a CI library removeClass event
	 *
	 * @access	public
	 * @param	string	- element
	 * @param	string	- Class to add
	 ...
	 * Slide Down
	 *
	 * Outputs a CI library slideDown event
	 *
	 * @access	public
	 * @param	string	- element
	 * @param	string	- One of 'slow', 'normal', 'fast', or time in milliseconds
	 ...
	 * Slide Toggle
	 *
	 * Outputs a CI library slideToggle event
	 *
	 * @access	public
	 * @param	string	- element
	 * @param	string	- One of 'slow', 'normal', 'fast', or time in milliseconds
	 ...
	 * Hide
	 *
	 * Outputs a CI library hide action
	 *
	 * @access	public
	 * @param	string	- element
	 * @param	string	- One of 'slow', 'normal', 'fast', or time in milliseconds
	 ...
	 * Toggle
	 *
	 * Outputs a CI library toggle event
	 *
	 * @access	public
	 * @param	string	- element
	 * @return	string
	 ...
	 * Toggle Class
	 *
	 * Outputs a CI library toggle class event
	 *
	 * @access	public
	 * @param	string	- element
	 * @return	string
	 ...
	 * Show
	 *
	 * Outputs a CI library show event
	 *
	 * @access	public
	 * @param	string	- element
	 * @param	string	- One of 'slow', 'normal', 'fast', or time in milliseconds
	 ...
	 * Clear Compile
	 *
	 * Clears any previous CI collected for output
	 *
	 * @access	public
	 * @return	void
	 */
	...
	{
		$str = '<script type="text/CI" charset="'.strtolower($this->CI->config->item('charset')).'"';
		$str .= ($src == '') ? '>' : ' src="'.$src.'">';
		return $str;
	}
